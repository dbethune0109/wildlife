...
public class EndangeredAnimalTest{
  ...
  @Before
  public void setUp(){
    testEndangeredAnimal = new EndangeredAnimal("fat", "snake", "healthy", "adolescent");
  }
  ...
  public void name_instantiatesCorrectly_true() {
    assertEquals("fat", testEndangeredAnimal.getName());
  }

  @Test
  public void species_instantiatesCorrectly_true() {
    assertEquals("snake", testEndangeredAnimal.getSpecies());
  }

  @Test
  public void equals_returnsTrueIfPropertiesAreSame_true(){
    EndangeredAnimal testEndangeredAnimal2 = new EndangeredAnimal("fat", "snake", "healthy", "adolescent");
  ...
  public void save_insertsEndangeredAnimalIntoDatabase_EndangeredAnimal() {
    ...
    try(Connection con = DB.sql2o.open()){
      testEndangeredAnimal2 = con.createQuery("SELECT * FROM animals WHERE name='fat'")
  ...
  public void all_returnsAllInstancesOfPerson_true() {
    testEndangeredAnimal.save();
    EndangeredAnimal testEndangeredAnimal2 = new EndangeredAnimal("stiff", "bigfoot", "ill", "old");
...
//Exception
  ...
  public void delete_deletesSightingAssociations(){
    testEndangeredAnimal.save();
    Sighting sighting = new Sighting("somewhere", "Milo");
  ...
  public void getSightings_returnsAllSightings_int(){
    testEndangeredAnimal.save();
    Sighting testSighting = new Sighting("somewhere", "MIlo");
    testSighting.save();
