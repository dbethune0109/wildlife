...
public class RegularAnimalTest{
  ...
  @Before
  public void setUp(){
    testRegularAnimal = new RegularAnimal("jackalope", "jackalope");
  }
  ...
  public void name_instantiatesCorrectly_true() {
    assertEquals("jackalope", testRegularAnimal.getName());
  }

  @Test
  public void species_instantiatesCorrectly_true() {
    assertEquals("jackalope", testRegularAnimal.getSpecies());
  }

  @Test
  public void equals_returnsTrueIfPropertiesAreSame_true(){
    RegularAnimal testRegularAnimal2 = new RegularAnimal("jackalope", "jackalope");
  ...
  public void save_insertsRegularAnimalIntoDatabase_RegularAnimal() {
    ...
    try(Connection con = DB.sql2o.open()){
      testRegularAnimal2 = con.createQuery("SELECT * FROM animals WHERE name='jackalope'").throwOnMappingFailure(false)
  ...
  public void all_returnsAllInstancesOfPerson_true() {
    testRegularAnimal.save();
    RegularAnimal testRegularAnimal2 = new RegularAnimal("fearful", "mightymouse");
